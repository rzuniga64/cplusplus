...
public:
	/******************************************************
	constructor: Initializes hash table to a 
				 predetermined size.
	*******************************************************/
	HashTable_3358();
	/******************************************************
	...
	***********************************************/
	...
	/******************************************************
	findPos: Return the position where the seach for
	string x terminates
	*******************************************************/
	...
	*******************************************************/
	...
	/******************************************************
	nextPrime: return a prime number at least as large 
			   as number.
	*******************************************************/
	unsigned int nextPrime(unsigned int number);
	/******************************************************
	size: return the number of strings stored in the 
		  hash table.
	*******************************************************/
	unsigned int size();
